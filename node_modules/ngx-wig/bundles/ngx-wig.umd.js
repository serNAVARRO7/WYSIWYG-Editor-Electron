(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-wig', ['exports', '@angular/core', '@angular/forms', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ngx-wig'] = {}, global.ng.core, global.ng.forms, global.ng.common));
    ...
    var BUTTONS = new i0.InjectionToken('BUTTONS');

    var NgxWigToolbarService = /** @class */ (function () {
        function NgxWigToolbarService(buttonLibraryConfig) {
            this._defaultButtonsList = [];
            this._buttonLibrary = buttonLibraryConfig.reduce(function (acc, val) { return (Object.assign(Object.assign({}, acc), val)); }, {});
            this._defaultButtonsList = Object.keys(this._buttonLibrary);
        }
        NgxWigToolbarService.prototype.setButtons = function (buttons) {
            if (!Array.isArray(buttons)) {
                throw new Error('Argument "buttons" should be an array');
            }
            this._defaultButtonsList = buttons;
        };
        NgxWigToolbarService.prototype.addStandardButton = function (name, title, command, styleClass, icon) {
        ...
        NgxWigToolbarService.prototype.getToolbarButtons = function (buttonsList) {
            var _this = this;
    ...
    NgxWigToolbarService.ɵprov = i0.ɵɵdefineInjectable({ factory: function NgxWigToolbarService_Factory() { return new NgxWigToolbarService(i0.ɵɵinject(BUTTONS)); }, token: NgxWigToolbarService, providedIn: "root" });
    ...
    NgxWigToolbarService.ctorParameters = function () { return [
        { type: Array, decorators: [{ type: i0.Inject, args: [BUTTONS,] }] }
    ]; };
    ...
    var NgxWigComponent = /** @class */ (function () {
        ...
        NgxWigComponent.prototype.execCommand = function (command, options) {
        ...
        NgxWigComponent.prototype.ngOnInit = function () {
        ...
        NgxWigComponent.prototype.ngAfterViewInit = function () {
            var _this = this;
        ...
        NgxWigComponent.prototype.ngOnDestroy = function () {
            if (this._mutationObserver) {
                this._mutationObserver.disconnect();
            }
        };
        NgxWigComponent.prototype.onContentChange = function (newContent) {
            this.content = newContent;
            this.contentChange.emit(this.content);
            this.propagateChange(this.content);
        };
        NgxWigComponent.prototype.ngOnChanges = function (changes) {
        ...
        NgxWigComponent.prototype.onTextareaChange = function (newContent) {
            // model -> view
            this.container.innerHTML = newContent;
            this.onContentChange(newContent);
        };
        NgxWigComponent.prototype.writeValue = function (value) {
            if (!value) {
                value = '';
            }
        ...
        NgxWigComponent.prototype.shouldShowPlaceholder = function () {
            return !!this.placeholder
                && !this.container.innerText;
        };
        NgxWigComponent.prototype.pasteHtmlAtCaret = function (html) {
            var sel, range;
        ...
        NgxWigComponent.prototype.registerOnChange = function (fn) {
            this.propagateChange = fn;
        };
        NgxWigComponent.prototype.registerOnTouched = function (fn) {
            this.propagateTouched = fn;
        };
        NgxWigComponent.prototype.onBlur = function () {
            this.hasFocus = false;
            this.propagateTouched();
        };
        NgxWigComponent.prototype.setDisabledState = function (isDisabled) {
        ...
        { type: i0.Component, args: [{
                    ...
                    providers: [
                        NgxWigToolbarService,
                        {
                            ...
                            useExisting: i0.forwardRef(function () { return NgxWigComponent; }),
                            multi: true
                        }
                    ],
    ...
    NgxWigComponent.propDecorators = {
        ...
        ngxWigEditable: [{ type: i0.ViewChild, args: ['ngWigEditable', { read: i0.ElementRef, static: true },] }]
    };

    function getWindowObject() {
        return window;
    }
    var ɵ0$1 = DEFAULT_LIBRARY_BUTTONS;
    var NgxWigModule = /** @class */ (function () {
        function NgxWigModule() {
        }
        NgxWigModule.forRoot = function (config) {
            return {
        ...
        NgxWigModule.forChild = function () {
    ...
    exports.CUSTOM_LIBRARY_BUTTONS = CUSTOM_LIBRARY_BUTTONS;
    exports.DEFAULT_LIBRARY_BUTTONS = DEFAULT_LIBRARY_BUTTONS;
...
//# sourceMappingURL=ngx-wig.umd.js.map
